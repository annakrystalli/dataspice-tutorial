...
Structure and mapping data are reported **per individual per plot**; sampling metadata, such as _per growth form sampling area (km<sup>2</sup>)_, are reported **per plot**. 
