...
Structure and mapping data are reported **per individual per plot**; sampling metadata, such as _per growth form sampling area (m<sup>2</sup>)_, are reported **per plot**. 
