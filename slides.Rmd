...
Luckily, a **whole bunch of other awesome folks** already thinking about these topics and interested in working on them! `r emo::ji("star_struck")`
...
#### tutorial repo: <https://github.com/annakrystalli/dataspice-tutorial>
#### useful links: <http://annakrystalli.me/dataspice-tutorial/useful_links.html>
...
readr::read_csv(here::here("data", "vst_perplotperyear.csv")) %>% head(6) %>% knitr::kable(format = 'html')
```
...
```{r, echo=FALSE, message=FALSE}
readr::read_csv(here::here("data", "vst_mappingandtagging.csv")) %>% head(6) %>% knitr::kable(format = 'html')
```
