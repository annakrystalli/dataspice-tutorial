...
##### Here's [an example to get you started](https://github.com/annakrystalli/dataspice-tutorial/data/metadata/biblio-half.csv)
...
##### Here's [an example to get you started](https://github.com/annakrystalli/dataspice-tutorial/data/metadata/attributes-half.csv)
...
- [`access.csv`](https://github.com/annakrystalli/dataspice-tutorial/data/metadata/access.csv)
- [`attributes.csv`](https://github.com/annakrystalli/dataspice-tutorial/data/metadata/attributes.csv)
- [`biblio.csv`](https://github.com/annakrystalli/dataspice-tutorial/data/metadata/biblio.csv)
- [`creators.csv`](https://github.com/annakrystalli/dataspice-tutorial/data/metadata/creators.csv)
